...
import com.sedodream.boggle.sih.player.TreeCharManagedPlayer;
import com.sedodream.boggle.sih.player.TreeCharSimplePlayer;

/**
 * @author Sayed Ibrahim Hashimi (sayed.hashimi@gmail.com)
 */
public class TestMT_TCP_TreeCharacter16x16 extends TestBase{
    @Test
    ...
    @Test
    @Ignore
    public void Test32Thread() throws Exception{
        DoTest(32);
    }
    @Test
    @Ignore
    ...
    public void DoTest(int numThreads) throws Exception{
        ...
        IBoard board = BuildBoardFromFile(".\\Files\\board16x16.txt");
        Assert.assertNotNull(board);
        
        System.out.println("Creating player(s)");
        
        TreeCharacter wordList = BuildCharDictionaryFromFile(wordListComplete);
        ...
        for(int i=0;i<numThreads;i++){
            IPlayer newPlayer = new TreeCharManagedPlayer(board,cellManager);
            Assert.assertNotNull(newPlayer);
            newPlayer.setTreeCharacter(wordList);
    ...
    public static void main(String[] args) throws Exception {
        BoggleMode.DEBUG_MODE=false;
        TestMT_TCP_TreeCharacter16x16 tester = new TestMT_TCP_TreeCharacter16x16();
        tester.Test8Thread();
    }
}

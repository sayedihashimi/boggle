 ...
 */
public class TestMT_TCP_TreeCharacter32x32 extends TestBase {
    @Test
    ...
    public void DoTest(int numThreads) throws Exception{
        ...
        PruningTreeCharacter wordList = BuildPruningDictionaryFromFile(wordListComplete);
    ...
    public static void main(String[] args) throws Exception {
        BoggleMode.DEBUG_MODE=false;
        TestMT_TCP_TreeCharacter32x32 tester = new TestMT_TCP_TreeCharacter32x32();
        tester.Test1Thread();
        tester.Test2Thread();
        tester.Test8Thread();
        tester.Test16Thread();

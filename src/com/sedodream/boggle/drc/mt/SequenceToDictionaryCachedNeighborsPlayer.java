 ...
 *
 */
public class SequenceToDictionaryCachedNeighborsPlayer implements IPlayer{
	 ...
	 */
	public SequenceToDictionaryCachedNeighborsPlayer(IDictionary theDictionary, IBoard theBoard, int theTlx, int theTly, int width, int height) {

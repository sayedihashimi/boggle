 ...
 *
 */
public class CharSequenceToDictionaryPlayer implements IPlayer{
	 ...
	 */
	public CharSequenceToDictionaryPlayer(IDictionary theDictionary, IBoard theBoard, int theTlx, int theTly, int width, int height) {
		this(theDictionary, theBoard, theTlx, theTly, width, height, 100);
	}
	
	public CharSequenceToDictionaryPlayer(IDictionary theDictionary, IBoard theBoard, int theTlx, int theTly, int width, int height, int maxWordSize) {

 ...
 *
 */
public class CharSequenceToDictionaryCachedNeighborsPlayer implements IPlayer{
	 ...
	 */
	public CharSequenceToDictionaryCachedNeighborsPlayer(IDictionary theDictionary, IBoard theBoard, int theTlx, int theTly, int width, int height) {
		this(theDictionary, theBoard, theTlx, theTly, width, height, 100);
	}
	
	public CharSequenceToDictionaryCachedNeighborsPlayer(IDictionary theDictionary, IBoard theBoard, int theTlx, int theTly, int width, int height, int maxWordSize) {
